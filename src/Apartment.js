...
export default class Apartment extends React.Component {
    ...
    render() {
        ...
        const allBoxes = this.props.allBoxes.map(box => {
            ...
            } else if (privateBed == "No, they sleep in a room with 2 other people.") {
                privateBed = "2 Roomates";
            } else if (privateBed == "No, they sleep in a room with 3+ other people.") {
            ...
            } else if (privateBath == "No, they share a bathroom with 2 other people.") {
                privateBath = "2 Bathmates";
            } else if (privateBath == "No, they sleep in a room with 3+ other people.") {
                    ...
                    <div className="box">
                        ...
                        <div className="box-link">
                            <div className="box-content">
                                ...
                                <a className="apartment-attributes" href={/post/ + box.uniqueId} target="_blank">
                                    <div className="apartment-attributes">
                                        <div className="top-box">
                                            ...
                                            <div className="apt-message-button">
                                                <Button onClick={(event) => { event.preventDefault(); event.stopPropagation(); this.sendMessage(box.uid) }} variant="primary" size="sm">
                                                    Send a message!
                                            </Button>
                                            </div>
                                        </div>
